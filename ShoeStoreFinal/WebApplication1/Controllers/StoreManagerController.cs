...
namespace WebApplication1.Controllers
{
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Productid,Genreid,Brandid,Title,Price,Size")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Productid,Genreid,Brandid,Title,Price,Size")] Product product)
        {
            if (ModelState.IsValid)
            {
